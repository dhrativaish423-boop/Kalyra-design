...
export default function TheVault() {
  const products = [
    { id: 1, name: "Royal Wedding Necklace Blueprint", price: "$349.00", image: "/vault.jpg", rating: 5 },
    { id: 2, name: "Banded Diamond Ring Sketch", price: "$159.00", image: "/vault.jpg", rating: 5 },
  ];

  return (
    <div className="min-h-screen bg-[#F7F3EC] p-6 text-[#1A1A1A]">
      <h1 className="text-3xl font-bold text-center text-[#4B1E3F] font-serif my-6">The Vault</h1>
      <p className="text-center text-gray-600 mb-8">Luxury jewelry sketches and manufacturing technical PDFs.</p>
